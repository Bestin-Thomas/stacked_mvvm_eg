...
class FvavView extends StatelessWidget {
  const FvavView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<FvavViewModel>.reactive(
      ...
      viewModelBuilder: () => FvavViewModel(),
    );
  }
}


class TitleSection extends ViewModelWidget<FvavViewModel> {
  TitleSection({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, FvavViewModel viewModel) {
